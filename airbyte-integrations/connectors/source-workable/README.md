...
An image will be built with the tag `airbyte/source-workable:dev`.
...
4. Make the connector documentation and its changelog is up to date (`docs/integrations/sources/workable.md`).
